  ...
  <body id="page-top">
    	...
    	<div class="container-contact2">
	      <div class="container">
	        <div class="intro-text">
	          <div class="intro-lead-in"><img src="${pageContext.request.contextPath}/images/critique-u-vector-serif-mono.svg" style="height: 200px;" /></div>
	          <div style="font-size: 24px; font-family: 'Montserrat', 'Helvetica Neue', Helvetica, Arial, sans-serif; margin-top: -30px; margin-bottom: 30px;">ARTIST-TO-ARTIST CRITIQUES</div>
    ...
    <footer>
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            <span class="copyright">Copyright &copy; CritiqueU 2018</span>
          </div>
          <div class="col-md-4">
